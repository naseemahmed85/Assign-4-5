...
export default function Aiinmotoring(){
    return(
        <div className="Parent1">
            ...
            Computer Vision and Object Recognition: AI systems use sensors, cameras, and radar to analyze the vehicle's surroundings. Computer vision algorithms enable vehicles to recognize objects, such as other cars, pedestrians, traffic signs, and lane markings.
            ...
            Adaptive Cruise Control (ACC): AI adjusts the vehicle's speed based on the distance from the car ahead, maintaining a safe following distance.
            ...
            Blind Spot Monitoring: AI helps detect vehicles or objects in the driver's blind spots and issues alerts to avoid accidents.
            </p>
